QA_SRC = \
 ...
 q_math q_shared \
 ai_dmnet ai_dmq3 ai_freeze ai_team ai_main ai_chat ai_cmd ai_vcmd \
 g_active g_arenas g_bot g_client g_cmds g_combat g_freeze g_items g_mem g_misc \
 g_missile g_mover g_session g_spawn g_svcmds g_target g_team \
 g_trigger g_utils g_weapon \

CG_SRC = \
 cg_main $(CGDIR)/cg_syscalls.asm \
 cg_consolecmds cg_draw cg_drawtools cg_effects cg_ents cg_event cg_freeze cg_info \
